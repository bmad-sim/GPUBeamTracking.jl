include("/home/gh452/.julia/dev/BeamTracking/src/low_level/structures.jl")
include("/home/gh452/.julia/dev/BeamTracking/src/low_level/sqrt_one.jl")
...
function track_a_drift(p_in, drift)
    ...
    return Particle = p_in

end

p_in = Particle(1.0, 1.0, 1.0, [1.0, 0.5, 1.0, 0.2, 1.0, 0.5])
drift = Drift(0.001)
